...
{
private:
    int numCircles;    ///< Number of boxes to draw on the screen.
    GLenum mode;     ///< Mode, either point, line or fill.
    int sscount;     ///< Screenshot count to be appended to the screenshot filename.
    Axes2D axes;
    Circle* circle;

    GLuint projLoc, modelLoc, colorLoc;            ///< Location of the projection matrix in the shader program.
    ...
    std::vector<Circle*> world;  ///< Vector holding a list of all the objects in the scene.
